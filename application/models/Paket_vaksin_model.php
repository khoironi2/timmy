...
class Paket_vaksin_model extends CI_Model
{
    ...
    {
        return $this->db->get('tbl_paket_vaksin');
    }

    function cari($id_paket_vaksin)
    {
        $query = $this->db->get_where('tbl_paket_vaksin', array('id_paket_vaksin' => $id_paket_vaksin));
        return $query;
    }
