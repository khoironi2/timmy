...
class Paket_groming_model extends CI_Model
{
    ...
    {
        return $this->db->get('tbl_paket_groming');
    }

    function cari($id_paket_groming)
    {
        $query = $this->db->get_where('tbl_paket_groming', array('id_paket_groming' => $id_paket_groming));
        return $query;
    }
