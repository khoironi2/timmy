...
class Paket_penitipan_model extends CI_Model
{
    ...
    {
        return $this->db->get('tbl_paket_penitpan');
    }

    function cari($id_paket_penitipan)
    {
        $query = $this->db->get_where('tbl_paket_penitpan', array('id_paket_penitipan' => $id_paket_penitipan));
        return $query;
    }
