...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/paket/vaksin/create'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nama_paket_vaksin">Nama Paket vaksin</label>
                        <input type="text" class="form-control" id="nama_paket_vaksin" name="nama_paket_vaksin" required>
                    </div>

                    <div class="form-group">
                        <label for="keterangan_paket_vaksin">Keterangan Paket vaksin</label>
                        <input type="text" class="form-control" id="keterangan_paket_vaksin" name="keterangan_paket_vaksin" required>
                    </div>

                    <div class="form-group">
                        <label for="harga_paket_vaksin">Harga Paket vaksin</label>
                        <input type="text" class="form-control" id="harga_paket_vaksin" name="harga_paket_vaksin" required>
                    </div>
