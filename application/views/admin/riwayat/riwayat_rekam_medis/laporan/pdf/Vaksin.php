...
<html lang="en"><head>
    ...
    <h4 style="background-color: #bdc3c7; color: black; padding: 1px; width: 370px; border: 1px solid #bdc3c7; margin-left: 330px; text-align: center;">LAPORAN DATA VAKSIN</h4>
        ...
        <tbody>
            ...
            foreach ($nasabah as $data) : ?>
                <tr>
                    ...
                    <td>Rp. <?= number_format($data->total_harga_vaksin, 0, ',', '.'); ?></td>
                </tr>
            <?php endforeach ?>
        </tbody>
    </table>
