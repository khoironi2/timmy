                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 col-sm-5">
                        <div class="slider-single-img slider-animated-1">
                            <img class="animated" src="<?= base_url('assets/frontend') ?>/img/slider/slider-single-img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-5 col-12">
                        <div class="slider-single-img slider-animated-1">
                            <img class="animated" src="<?= base_url('assets/frontend') ?>/img/slider/slider-single-img-2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-food-category cate-padding-2 text-center mb-30">
                    <div class="single-food-hover-2">
                        <img src="<?= base_url('assets/frontend') ?>/img/product/product-2.jpg" alt="">
                    </div>
                    <div class="single-food-content">
                        <h3>Cats Food</h3>
                    </div>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-food-category cate-padding-3 text-center mb-30">
                    <div class="single-food-hover-2">
                        <img src="<?= base_url('assets/frontend') ?>/img/product/product-3.jpg" alt="">
                    </div>
                    <div class="single-food-content">
                        <h3>Fishs Food</h3>
                    </div>
        ...
        <div class="row">
                ...
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-4.jpg" alt="">
                        </a>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-5.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-6.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-7.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-8.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-9.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-10.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="product-wrapper mb-10">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="<?= base_url('assets/frontend') ?>/img/product/product-11.jpg" alt="">
                        </a>
                        <div class="product-action">
                            <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                <i class="ti-plus"></i>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="deal-img wow fadeInLeft">
                    <a href="#"><img src="<?= base_url('assets/frontend') ?>/img/banner/banner-2.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
...
<div class="testimonial-area pt-90 pb-70 bg-img" style="background-image:url(<?= base_url('assets/frontend') ?>/img/banner/banner-1.jpg);">
    <div class="container">
        <div class="row">
                ...
                <div class="testimonial-wrap">
                    ...
                    <div class="testimonial-image-slider text-center">
                        <div class="sin-testiImage">
                            <img src="<?= base_url('assets/frontend') ?>/img/testi/3.jpg" alt="">
                            <h3>Robiul Islam</h3>
                            <h5>Customer</h5>
                        </div>
                        <div class="sin-testiImage">
                            <img src="<?= base_url('assets/frontend') ?>/img/testi/4.jpg" alt="">
                            <h3>Robiul Islam</h3>
                            <h5>Customer</h5>
                        </div>
                        <div class="sin-testiImage">
                        ...
                        <div class="sin-testiImage">
                            <img src="<?= base_url('assets/frontend') ?>/img/testi/5.jpg" alt="">
                            <h3>T. T. Rayed</h3>
                            <h5>CEO</h5>
                        </div>
                    </div>
                    <div class="testimonial-shap">
                        <img src="<?= base_url('assets/frontend') ?>/img/icon-img/testi-shap.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="service-content text-center mb-30 service-color-1">
                    <img src="<?= base_url('assets/frontend') ?>/img/icon-img/shipping.png" alt="">
                    <h4>FREE SHIPPING</h4>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="service-content text-center mb-30 service-color-2">
                    <img src="<?= base_url('assets/frontend') ?>/img/icon-img/support.png" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="service-content text-center mb-30 service-color-3">
                    <img src="<?= base_url('assets/frontend') ?>/img/icon-img/money.png" alt="">
                    <h4>MONEY RETURN</h4>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30 gray-bg">
                    <div class="blog-img hover-effect">
                        <a href="blog-details.html"><img alt="" src="<?= base_url('assets/frontend') ?>/img/blog/blog-1.jpg"></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30 gray-bg">
                    <div class="blog-img hover-effect">
                        <a href="blog-details.html"><img alt="" src="<?= base_url('assets/frontend') ?>/img/blog/blog-2.jpg"></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30 gray-bg">
                    <div class="blog-img hover-effect">
                        <a href="blog-details.html"><img alt="" src="<?= base_url('assets/frontend') ?>/img/blog/blog-3.jpg"></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <ul>
