...
--
-- Host: localhost:3306
-- Generation Time: Jan 12, 2021 at 10:09 PM
...
(13, 10, 4, '', 'belum', '2021-01-07 14:49:28', '2021-01-07 14:49:28', 13),
(14, 10, 6, '', 'belum', '2021-01-12 08:17:25', '2021-01-12 08:17:25', 14),
(15, 10, 4, '', 'belum', '2021-01-12 08:19:30', '2021-01-12 08:19:30', 15),
(16, 5, 4, '', 'belum', '2021-01-12 22:03:07', '2021-01-12 22:03:07', 13);
...
(11, 10, 'pui', 3, 'id_petshop', 'ya', 'kucing sehat', '2021-01-07 14:50:04', '35000', '2021-01-07');
...
(14, 10, 'pui', '7', 6, '-', '2021-01-07 14:50:38', '175000');
...
(13, 10, 'pui', 2, '', '2021-01-07 14:49:22', '250000', 4, 'antri'),
(14, 10, 'popo', 2, '', '2021-01-12 08:17:19', '250000', 6, 'antri'),
(15, 10, 'popo', 3, '', '2021-01-12 08:19:23', '250000', 4, 'antri');
...
(12, 10, 'pui', 2, '', '2021-01-07 14:48:51', '200000', 6, 'visit'),
(13, 5, 'cio', 1, '', '2021-01-29 22:02:00', '200000', 4, 'antri');
...
(2, 'putri', 'putri@gmail.com', '$2y$10$3bbhpuNkyc3c/96L4Lu/du4W1n0hQXVLK1ZlxG5ezHaw.A25Jg3si', 'admin', '2021-01-07 17:32:09', '2021-01-07 14:52:34', 'Jl. Jambu Batua', 'foto_bung_hatta.jpg', '2020-11-16 21:26:17', '0000-00-00 00:00:00', '08512387434', 'oks', 'dzs', 'dss', 'dsse'),
...
(4, 'dokter.putri', 'dokter.putri@gmail.com', '$2y$10$57Tu2ib7rFVpEzAbZNXCHuoHPYkmh6Am6LgDTc6rbFOGSsXDteISe', 'dokter', '2021-01-07 14:52:46', '2021-01-07 14:53:16', 'Jl. Jambu Batu', '088421900_1588036966-aj.jpg', '2020-11-16 21:53:14', '0000-00-00 00:00:00', '08512387434', 'ok', 'dz', 'd', 'd'),
(5, 'cio', 'cio@gmail.com', '$2y$10$3eDEyI.nU.Hy0PsHb4qu8evWKBLASJ17DpG.KOStEpckG7WsSb/ii', 'pasien', '2021-01-12 22:02:28', '2020-12-31 00:41:25', '', '', '2020-11-17 12:42:28', '0000-00-00 00:00:00', '', '', '', '', ''),
...
(10, 'qonita', 'qonita@gmail.com', '$2y$10$P490TTMrlICqkATIT1CJQuEW9SN0Q5XLwB7fc4CYl6aSTd9erah0O', 'pasien', '2021-01-12 08:16:43', '2021-01-07 14:50:55', '', '', '2020-12-22 10:14:00', '0000-00-00 00:00:00', '', '', '', '', ''),
...
(6, 10, 6, 'waiting', '2021-01-07 14:48:59', '2021-01-07 14:48:59', 12);
...
--
ALTER TABLE `tbl_antrian_pasien`
  MODIFY `id_antrian_pasien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_boking_groming`
--
ALTER TABLE `tbl_boking_groming`
  MODIFY `id_boking_groming` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_boking_penitipan`
--
ALTER TABLE `tbl_boking_penitipan`
  MODIFY `id_boking_penitipan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_boking_steril`
--
ALTER TABLE `tbl_boking_steril`
  MODIFY `id_boking_steril` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_boking_vaksin`
--
ALTER TABLE `tbl_boking_vaksin`
  MODIFY `id_boking_vaksin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_visit_pasien`
  MODIFY `id_visit_pasien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
